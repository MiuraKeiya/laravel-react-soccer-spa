import { groupGamesByLeague, formatDate } from "../../../functions/Utils";
    ...
    return (
        <div>
            {Object.keys(gamesByLeague).length === 0 ? (
                ...
                Object.keys(gamesByLeague).map((leagueName, index) => {
                    ...
                    return (
                        <div key={index} className="text-[#EEEEEE] mt-2 mb-2">
                            ...
                            {leagueGames.map((game, gameIndex) => (
                                <div
                                    key={gameIndex}
                                    className="flex items-center justify-between border-b border-[#050608] text-[16px] hover:bg-[#3d4e81] cursor-pointer transition duration-500"
                                >
