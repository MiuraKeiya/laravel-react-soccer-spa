import { latestGames } from "../../../functions/Utils";
import { formatDatePart } from "../../../functions/Utils";
import { formatDate } from "../../../functions/Utils";
import { StandingsAll } from "../Team/Standing/StandingsAll";

export const LeagueOverview = ({ games, standings }) => {
    const nearestGames = latestGames(games);
    console.log(nearestGames);
    return (
        <div className="mt-2">
