            ...
            {informations.map((statistic, index) => (
                <div key={index} className="flex justify-between space-x-2">
                    <div>
                        ...
                        <div className="flex justify-between items-center bg-[#111931] w-[20rem] h-11 mt-1 border-t-2 border-[#b657f5]">
                        ...
                        <div className="flex justify-between items-center bg-[#111931] w-[20rem] h-11 mt-[1px]">
                            <h2 className="text-[#EEEEEE] pl-3">
                                アウェイゴール
                            </h2>
                            <span className="text-white font-bold pr-3">
