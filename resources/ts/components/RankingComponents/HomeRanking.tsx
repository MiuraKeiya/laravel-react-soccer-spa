    ...
    return (
        <div className="mt-[1px] mb-2">
            <table className="w-full">
                ...
                {rankingData.home.map((home, index) => (
                    <tbody className="text-[#EEEEEE]" key={index}>
                        <tr className="border-b border-[#111931] text-center h-8">
                            ...
                            <td className="text-[13px]">{home.home.played}</td>
                            <td className="text-[13px]">{home.home.win}</td>
                            <td className="text-[13px]">{home.home.draw}</td>
                            <td className="text-[13px]">{home.home.lose}</td>
                            <td className="text-[13px]">
                                {home.home.goals.for}:{home.home.goals.against}
                            </td>
                            <td className="text-[13px]">
                                {home.home.goals.for - home.home.goals.against}
                            </td>
