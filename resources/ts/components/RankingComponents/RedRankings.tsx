        ...
        <div className="mt-[1px] mb-2">
            {scoreData.json_red_ranking.response.length > 0 ? (
                <table className="w-full">
                    ...
                    {scoreData.json_red_ranking.response.map(
                        (scorer, index) => (
                ...
                // json_red_rankingキーが存在しない場合に表示するコード
